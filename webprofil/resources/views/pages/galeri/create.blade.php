...
@section('content')
    <div class="widget">
        ...
        <div class="widget-content padding">
            <div id="basic-form">
                <form role="form" method="post" enctype="multipart/form-data" action="{{route('galeri.store')}}">
                    {{csrf_field()}}
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control {{$errors->has('tempat')?'is-invalid':''}}" name="tempat">
